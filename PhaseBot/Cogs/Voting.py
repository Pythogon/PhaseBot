...
class Voting(commands.Cog):
	...
	async def votes(self, ctx, number: int):
		...
		used_users = []
		headers = {"user-agent": "Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.88 Mobile Safari/537.36 Edg/87.0.664.57", "cookies": '{"sessionid": {}}'.format(glo.GLOBAL_READ("igsessionid"))}
		print("t")
